    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i <= numeros.length; i++) {
            try { //Tente fazer isso
                ...
                System.out.println("Está acessando uma posição que não existe");    //caso não consiga, pegue o erro, "e" é uma variável.
            }finally { //só funciona dentro de um contexto (Try e Catch)
